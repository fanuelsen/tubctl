...
func EncodeControl(updates map[string]any, current *Status) ([]byte, error) {
	...
	val := func(a WritableAttr) any {
		...
		case "heat_power":
			return current.HeatPower
		case "filter_power":
			return current.FilterPower
		case "wave_power":
			return current.WavePower
		case "locked":
			return current.Locked
		case "earth":
			return current.Earth
		case "temp_set_unit":
			return current.TempSetUnit
		case "temp_set":
			return current.TempSet
		case "heat_appm_min":
			return current.HeatAppmMin
		case "heat_timer_min":
			return current.HeatTimerMin
		case "filter_appm_min":
			return current.FilterAppmMin
		case "filter_timer_min":
			return current.FilterTimerMin
		case "wave_appm_min":
			return current.WaveAppmMin
		case "wave_timer_min":
			return current.WaveTimerMin
		}
		return 0
	}
